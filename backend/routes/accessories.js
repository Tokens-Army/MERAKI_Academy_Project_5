...
const {createNewAccessories,getAllAccessories,deleteAccessoryById,updateArticleById}=require("../controllers/accessories")
//controllers
...
accessoriesRouter.put("/:id",updateArticleById)
